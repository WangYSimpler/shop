...
var headers = [{'buyDate':'交易日期','orderNo':'订单编号','orderName':'订单名称','orderObject':'产品类型','orderPrice':'产品单价','orderNum':'订单数量','orderAmount':'订单总额','orderStatus':'订单状态','freeNum':'赠送数量','buyAddress':'买家地址','add':'添加','delete':'删除'}];
